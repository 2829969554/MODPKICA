...
package smocsp // import "golang.org/x/crypto/ocsp"
...
crypto.MD4  在本文件中特指 SM3签名算法

*/
var hashOIDs = map[crypto.Hash]asn1.ObjectIdentifier{
	crypto.MD4: asn1.ObjectIdentifier([]int{1,2,156,10197,1,401}),
}
...
var signatureAlgorithmDetails = []struct {
	...
	{x509.SM2WithSM3, oidSignatureSM3WithSM2, x509.SM2, crypto.MD4},
}
...
func signingParamsForPublicKey(pub interface{}, requestedSigAlgo x509.SignatureAlgorithm) (hashFunc crypto.Hash, sigAlgo pkix.AlgorithmIdentifier, err error) {
	...
	default:
		err = errors.New("x509: only SM2 keys supported")
	}
...
func CreateResponse(issuer, responderCert *x509.Certificate, template Response, priv crypto.Signer,sm2pri *sm2.PrivateKey) ([]byte, error) {
	var publicKeyInfo struct {
		Algorithm pkix.AlgorithmIdentifier
		PublicKey asn1.BitString
	}
	...
	if template.IssuerHash == 0 {
		template.IssuerHash = crypto.MD4
	}
	hashOID := oidSignatureSM3WithSM2
	if hashOID == nil {
