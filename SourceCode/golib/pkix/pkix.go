	...
	for _, rdn := range *rdns {
		...
		for _, atv := range rdn {
			...
			if len(t) == 4 && t[0] == 2 && t[1] == 5 && t[2] == 4 {
				...
				case 18:
					n.EVTYPE = append(n.EVTYPE, value)
				case 19:
					n.EVCITY = append(n.EVCITY, value)
				case 20:
...
func (n Name) ToRDNSequence() (ret RDNSequence) {
	...
	ret = n.appendRDNs(ret, n.EVTYPE, oidEVTYPE)
...
func (n Name) String() string {
	...
	if n.ExtraNames == nil {
		for _, atv := range n.Names {
			...
			if len(t) == 4 && t[0] == 2 && t[1] == 5 && t[2] == 4 {
				switch t[3] {
				case 3, 5, 6, 7, 8, 9, 10, 11, 17,18,19,20,21:
